            ...
            <div class="p-5">
                ...
                md:flex-row rounded-xl dark:border-gray-700 dark:bg-gray-600 w-full text-white">
				 	<div class="pt-5 grid grid-cols-3">
                        ...
                        <div class="grid-span-1 flex justify-center items-center">Dato extra</div>
					</div>
                    <div class="py-2 text-center">
                        poto sample text, aqui mas divs
                    </div>

                    <div class="grid grid-cols-6 my-5 gap-y-5">
                        <label for="card_name" class="flex justify-center items-center text-md font-medium text-white col-span-3">Número de tarjeta</label>
                        ...
                        <label for="cvv" class="flex justify-center items-center text-md font-medium text-white col-span-3">CVV</label>
                        ...
                        <label for="exp_date" class="flex justify-center items-center text-md font-medium text-white col-span-3">Fecha Vencimiento</label>
                        <select id="month" name="month" class=" w-36 px-3 py-2 text-black border border-gray-300 rounded-lg 
                        ...
                        <span class="flex justify-center items-center ml-8 font-bold text-3xl col-span-1 w-auto">/</span>
                        <select id="year" name="year" class="w-auto px-3 mr-8 py-2 text-black border border-gray-300 rounded-lg 
                        focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 col-span-1">
                        ...
                        <label for="card_psswd" class="flex justify-center items-center text-md font-medium text-white col-span-3">Contraseña</label>
        ...
        <div class="col-span-1 col-start-1 row-span-3">
            ...
            <div class="p-5">
                ...
                md:flex-row rounded-xl dark:border-gray-700 dark:bg-gray-600 w-full text-white">
                    ...
                    <div class="grid grid-cols-2 my-5 gap-y-5">
                        <label for="card_name" class="flex justify-center items-center text-md font-medium text-white col-span-1">Cliente</label>
                        <input type="text" id="first_name" class="bg-white border border-gray-300 text-black text-sm rounded-lg 
                        ...
                        <label for="cvv" class="flex justify-center items-center text-md font-medium text-white col-span-1">Número de orden</label>
                        <input type="number" id="first_name" class="bg-white border border-gray-300 text-black text-sm rounded-lg 
                        focus:ring-blue-500 focus:border-blue-500 block w-auto mr-64 p-2.5 dark:border-gray-600 dark:placeholder-gray-500 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500 col-span-1" placeholder=" xxxxx    " required />
                        
                        <label for="exp_date" class="flex justify-center items-center text-md font-medium text-white col-span-1">Cantidad de productos</label>
                        <input type="number" id="first_name" class="bg-white border border-gray-300 text-black text-sm rounded-lg 
                        focus:ring-blue-500 focus:border-blue-500 block w-auto mr-64 p-2.5 dark:border-gray-600 dark:placeholder-gray-500 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500 col-span-1" min="0" placeholder=" xxxxx    " required />
                        
                        <label for="card_name" class="flex justify-center items-center text-md font-medium text-white col-span-1">Subtotal</label>
                        <input type="text" id="first_name" class="bg-white border border-gray-300 text-black text-sm rounded-lg 
                        focus:ring-blue-500 focus:border-blue-500 block w-40 p-2.5 dark:border-gray-600 dark:placeholder-gray-500 
                    ...
                    <div class="grid grid-cols-2">
                        <span class="col-span-1 text-center">Total a pagar = $142.000,00 (con IVA)</span>
