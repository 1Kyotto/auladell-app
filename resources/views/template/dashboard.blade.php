...
<html lang="en">
    ...
    <body class="w-full h-[100dvh] grid grid-cols-12 bg-[#060606] text-cwhite-500 font-cinzel">
        {{--SIDEBAR--}}
        <div class="col-span-3 flex flex-col justify-between w-full h-full">
            <div class="flex flex-col justify-between gap-12">
                {{--LOGO--}}
                <div class="w-full flex flex-col items-center px-12 mt-10">
                ...
                <div class="flex flex-col justify-between gap-3 items-start">
                    <div class="mx-12 text-sm">Menú</div>
                    <div class="w-full flex flex-col">
                        ...
                        {{ request()->routeIs('admin.order') ? 'bg-[#0E0E0E] border-l-[3px] border-l-[#006C55]' : 'border-l-[3px] border-l-transparent' }}">
                            ...
                            Pedidos</a>
                        <a href="{{ route('admin.material') }}" class="w-full px-12 pt-5 pb-5 flex items-center gap-4 border-b
                        {{ request()->routeIs('admin.material') ? 'bg-[#0E0E0E] border-l-[3px] border-l-[#006C55]' : 'border-l-[3px] border-l-transparent' }}">
                            <div class="bg-[#006C55] w-8 h-8 flex items-center justify-center rounded-lg">
            ...
            {{-- LOGOUT --}}
            <div class="relative cursor-pointer w-full px-12 mb-12 border-t pt-6 border-[#CED4E0]">
                <div id="adminDropdownToggle" class="flex items-center justify-between"onclick="toggleDropdown()">
                    <span>{{ $adminName }}</span>
                ...
                {{--DROPDOWN MENU--}}
                <div id="adminDropdownMenu" class="hidden absolute top-full left-10 bg-[#0E0E0E] shadow-lg border rounded-md w-[calc(100%-50px)] mt-2 z-10">
        ...
        {{--CONTENIDO--}}
        <div class="col-span-9 rounded-xl bg-[#0E0E0E]">
            @yield('content')
        </div>
        {{--CONTENIDO--}}
    </body>
