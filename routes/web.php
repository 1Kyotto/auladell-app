...
Route::middleware(['auth', \App\Http\Middleware\AuthAdmin::class])->group(function () {
    ...
    Route::post('/dashboard/product/store-step1', [AdminProdController::class, 'storeStep1'])->name('admin.products.store-step1'); //funcion agregar un producto

    Route::patch('/dashboard/product/{product}/toggle-status', [AdminProdController::class, 'toggleStatus'])->name('admin.product.toggle-status'); //funcion editar un producto
